...
plotDEG(sbLog, soybean_ir_metrics, option="scatterPoints", threshVar = "PValue", threshVal = 0.05/nrow(sbLog))
plotDEG(sbLog, soybean_ir_metrics, option="scatterPoints", threshVar = "PValue", threshVal = 0.01/nrow(sbLog))
