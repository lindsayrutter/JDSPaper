...
Moreover, we can also confirm that the read counts between the Y4 replicates fall closer to the \textit{x=y} than those between the Y1 replicates. This should be expected as the Y1 replicates should have additional technical variability from the use of two different flow cells (Table~\ref{tableYeast}). As such, the scatterplot matrix is also useful to quickly confirm for expected patterns of variability in the dataset.
