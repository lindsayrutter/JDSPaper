...
Here, we use real RNA-seq data to demonstrate that our proposed visualization tools can detect normalization issues, DEG designation issues, and common errors in the analysis pipeline. We also should that our tools can elicit genes of interest that cannot otherwise be obtained with any models. In line with modern multivariate data exploration, we emphasize that interactive graphics should be an indisposable component of RNA-seq analysis. Users should be able to quickly view subsets of genes that appear promising or problematic, and link between different plots to quickly obtain various perspectives of their data. In this paper, we are not proposing that users completely change their approach to RNA-seq analysis. Instead, we propose that users simply modify their approach to RNA-seq analysis by incorporating meaningful multivariate graphical tools, including scatterplot matrices, parallel coordinate plots, and replicate line plots.
...
% Examples
%\bibitem{ }  Hastie, T., Tibshirani, R., and Friedman, J. (2001). \textit{The Elements of Statistical Learning: Data Mining, Inference, and Prediction}. New York: Springer.

%\bibitem{ } Cox, D. R. (1972). Regression models and life tables (with discussion).  \textit{Journal of the Royal Statistical Society, Series B} \textbf{34,} 187--200.
