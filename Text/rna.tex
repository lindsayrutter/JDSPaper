...
\section*{Title}
\noindent Visualization methods for RNA-sequencing data analysis

\section*{Authors}
\noindent Lindsay Rutter$^{1}$ and Dianne Cook$^{2}$\\
$^{1}$Bioinformatics and Computational Biology Program, Iowa State University\\
$^{2}$Department of Department of Econometrics and Business Statistics, Monash University
