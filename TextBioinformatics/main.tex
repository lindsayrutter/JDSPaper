...
R\citep{R}  was used to conduct analyses in this paper, and particularly packages ggplot2\citep{ggplot2}, shiny\citep{shiny},  and plotly\citep{plotly} were used to build the graphics. 
