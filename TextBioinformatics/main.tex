...
We can also plot the significant genes from the four clusters of the iron-metabolism soybean dataset shown in Figure~\ref{clusterPCP4Sig} onto the scatterplot matrix. The results are shown and briefly discussed in Supplementary Figures 2-5. 
