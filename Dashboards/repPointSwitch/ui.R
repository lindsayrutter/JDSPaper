...
sidebar <- dashboardSidebar(
  ...
  hr(),
  sidebarMenu(id="tabs",
    shinydashboard::menuItem("Application", tabName="hexPlot"), #hexPlot
...
body <- dashboardBody(
  tabItems(
    ...
    shinydashboard::tabItem(tabName = "about",
      ...
      br(),
      shiny::fluidRow("Please use the 'Application' tab to interact with published RNA-seq data of soybean developmental stages S1 and S2 (Brown and Kudson, 2015). Please note that, in this example, we switched the third replicate of the S1 treatment group with the first replicate of the S2 treatment group.", style='padding:10px;'),
      br(),
